...
#关于本人更改
1. 2017/03/06 出现无法登陆的错误……再等等看
1. 2017/02/14 感谢popite和Yufeikang， 修复302重定向错误，故打包bcloud_3.8.1-3_all.deb,供ubuntu/debian用户使用。
1. 2017/02/08 今天再重新登陆了一下bcloud发现无法登陆了，应该是百度云盘网页版又作修改了。呃坐等大神来解决吧，不过似乎都放弃了？
